...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-crm-prospecting-agent?sort=semver)](https://github.com/liberusoftware/module-crm-prospecting-agent/releases/latest) [![Tests](https://github.com/liberusoftware/module-crm-prospecting-agent/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-crm-prospecting-agent/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-crm-prospecting-agent
```
...
<a href="https://github.com/liberusoftware/module-crm-prospecting-agent/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-crm-prospecting-agent" alt="Contributors to liberusoftware/module-crm-prospecting-agent">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-crm-prospecting-agent/graphs/contributors).
